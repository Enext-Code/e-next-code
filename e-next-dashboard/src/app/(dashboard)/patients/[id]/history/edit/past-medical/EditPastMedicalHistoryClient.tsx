...
import EditPatientPastMedicalHistory from '@/components/patients/history/edit/edit-patient-past-medical-history';
...
export default function EditPastMedicalHistoryPage({ params }: { params: PageParams }) {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Edit Past Medical History' }
  ];
...
{/* <div className={styles.marginTab}>
        ...
        <EditPatientPastMedicalHistory patientId={params.id} />
      </div>
    </>
  );
} 