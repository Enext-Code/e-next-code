...
import EditPatientInvestigation from '@/components/patients/history/edit/edit-patient-investigation';
...
export default function EditInvestigationHistoryClient({ params }: { params: PageParams }) {
  ...
  return (
    <>
      <div className={styles.pageContainer}>
        <h2 style={{fontSize: '24px', fontWeight: '600'}}>Edit Investigation</h2>
        <Breadcrumb 
...
{/* <div className={styles.marginTab}>
        ...
        <EditPatientInvestigation patientId={params.id} />
      </div>
    </>
  );
} 