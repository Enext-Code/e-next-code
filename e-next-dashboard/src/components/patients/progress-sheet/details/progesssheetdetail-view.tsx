...
export default function ProgressSheetView() {
  ...
  const BedIcon = ({ bedNumber }: { bedNumber: number }) => (
    <svg width="95" height="112" viewBox="0 0 90 85" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const handlePatientChange = (newPatientId: string) => {
    ...
    router.push(`/patients/${newPatientId}/progress-sheet`);
  };
          ...
          <>
            <div className={styles.dateSelector}>
              ...
              <div className={styles.dateTabs}>
                {Array.from({ length: Math.min(daysSinceAdmission, 1000) }, (_, i) => {
